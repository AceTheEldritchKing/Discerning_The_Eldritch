...
public class CataclysmBladeSmallProjectile extends AbstractMagicProjectile implements GeoEntity {
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
    private int hitsPerTick;

    public CataclysmBladeSmallProjectile(EntityType<? extends Projectile> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
        this.setNoGravity(true);
    }

    public CataclysmBladeSmallProjectile(Level pLevel, LivingEntity pShooter) {
        super(DTEEntityRegistry.CATACLYSM_BLADE_SMALL.get(), pLevel);
