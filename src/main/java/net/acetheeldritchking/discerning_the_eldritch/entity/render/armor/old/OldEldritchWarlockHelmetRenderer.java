package net.acetheeldritchking.discerning_the_eldritch.entity.render.armor.old;

import mod.azure.azurelib.common.api.client.renderer.GeoArmorRenderer;
import mod.azure.azurelib.common.api.client.renderer.layer.AutoGlowingGeoLayer;
import mod.azure.azurelib.common.internal.client.util.RenderUtils;
import mod.azure.azurelib.common.internal.common.cache.object.GeoBone;
import net.acetheeldritchking.discerning_the_eldritch.entity.armor.EldritchWarlockHelmetModel;
...
public class OldEldritchWarlockHelmetRenderer extends GeoArmorRenderer<OldEldritchWarlockHelmetItem> {
    public OldEldritchWarlockHelmetRenderer() {
        super(new EldritchWarlockHelmetModel());
        addRenderLayer(new AutoGlowingGeoLayer<>(OldEldritchWarlockHelmetRenderer.this));
    }
