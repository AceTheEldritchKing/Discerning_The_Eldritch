...
import net.acetheeldritchking.discerning_the_eldritch.entity.armor.EldritchWarlockMaskModel;
...
public class OldEldritchWarlockMaskRenderer extends GeoArmorRenderer<OldEldritchWarlockMaskItem> {
    public OldEldritchWarlockMaskRenderer() {
        super(new EldritchWarlockMaskModel());
        addRenderLayer(new AutoGlowingGeoLayer<>(OldEldritchWarlockMaskRenderer.this));
    }
