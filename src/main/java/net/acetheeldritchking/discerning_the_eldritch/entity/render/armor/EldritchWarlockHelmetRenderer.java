...
public class EldritchWarlockHelmetRenderer extends GeoArmorRenderer<EldritchWarlockHelmetItem> {
    public EldritchWarlockHelmetRenderer() {
        super(new EldritchWarlockHelmetModel());
        addRenderLayer(new AutoGlowingGeoLayer<>(EldritchWarlockHelmetRenderer.this));
    }
