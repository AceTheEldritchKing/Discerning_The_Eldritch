...
@OnlyIn(Dist.CLIENT)
public class LanternOfHatredEquippedCurioRenderer implements ICurioRenderer {
    private final LanternOfHatredEquippedItemRenderer curioRenderer = new LanternOfHatredEquippedItemRenderer();
    ...
    public <T extends LivingEntity, M extends EntityModel<T>> void render(
        ...
        ResourceLocation textureLocation = LanternOfHatredEquippedItemRenderer.TEX;
