...
public class OldEldritchWarlockArmorRenderer extends GeoArmorRenderer<OldEldritchWarlockArmorItem> {
    public OldEldritchWarlockArmorRenderer() {
        super(new EldritchWarlockArmorModel());
        addRenderLayer(new AutoGlowingGeoLayer<>(OldEldritchWarlockArmorRenderer.this));
    }
