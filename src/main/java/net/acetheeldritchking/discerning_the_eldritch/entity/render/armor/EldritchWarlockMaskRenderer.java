...
public class EldritchWarlockMaskRenderer extends GeoArmorRenderer<EldritchWarlockMaskItem> {
    public EldritchWarlockMaskRenderer() {
        super(new EldritchWarlockMaskModel());
        addRenderLayer(new AutoGlowingGeoLayer<>(EldritchWarlockMaskRenderer.this));
    }
