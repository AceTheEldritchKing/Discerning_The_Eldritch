...
public class BloodCultistWitchEntity extends BloodMageEntity implements Enemy, IAnimatedAttacker {
    public BloodCultistWitchEntity(EntityType<? extends PathfinderMob> pEntityType, Level pLevel) {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(3, new GenericAnimatedWarlockAttackGoal<>(this, 1.5f, 25, 40)
                ...
                .setSpells(
                        // Attack
                        List.of(SpellRegistry.BLOOD_NEEDLES_SPELL.get(), SpellRegistry.ACUPUNCTURE_SPELL.get(), SpellRegistry.WITHER_SKULL_SPELL.get(), SpellRegistry.BLOOD_SLASH_SPELL.get()),
                        // Defense
    ...
    private final AnimationController<BloodCultistWitchEntity> meleeController = new AnimationController<>(this, "keeper_animations", 0, this::predicate);
    ...
    private PlayState predicate(AnimationState<BloodCultistWitchEntity> animationState)
    {
