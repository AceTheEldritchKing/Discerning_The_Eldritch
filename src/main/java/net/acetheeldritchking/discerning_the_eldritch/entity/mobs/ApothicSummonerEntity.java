...
public class ApothicSummonerEntity extends NeutralWizard implements Enemy {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(3, new WizardAttackGoal(this, 1.25f, 50, 75)
                .setSpells(
                        // Attack
                        List.of(SpellRegistries.ESOTERIC_EDGE.get(), SpellRegistry.TELEKINESIS_SPELL.get(), SpellRegistry.RAISE_DEAD_SPELL.get()),
                        // Defense
                        List.of(SpellRegistry.COUNTERSPELL_SPELL.get(), SpellRegistry.HEAL_SPELL.get()),
                        // Movement
                ...
                ).setSingleUseSpell(SpellRegistries.SILENCE.get(), 80, 400, 1, 3)
                .setDrinksPotions());
