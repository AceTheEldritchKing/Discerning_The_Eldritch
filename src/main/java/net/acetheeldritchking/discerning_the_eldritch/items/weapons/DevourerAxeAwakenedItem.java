...
public class DevourerAxeAwakenedItem extends MagicSwordItem implements UniqueItem {
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltipComponents, TooltipFlag tooltipFlag) {
        ...
        if (Screen.hasShiftDown())
        {
            ...
            tooltipComponents.add(Component.translatable(this.getDescriptionId() + ".desc2").append(String.valueOf(MinecraftInstanceHelper.getPlayer().getData(DTEAttachmentRegistry.DEVOURED_ENTITIES))).
                    withStyle(ChatFormatting.DARK_PURPLE).
