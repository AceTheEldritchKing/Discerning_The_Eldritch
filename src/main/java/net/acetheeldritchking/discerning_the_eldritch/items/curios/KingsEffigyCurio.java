...
public class KingsEffigyCurio extends SimpleDescriptiveCurio {
    ...
    public Multimap<Holder<Attribute>, AttributeModifier> getAttributeModifiers(SlotContext slotContext, ResourceLocation id, ItemStack stack) {
        ...
        attr.put(ASAttributeRegistry.SPELL_RES_PENETRATION, new AttributeModifier(id, 0.10, AttributeModifier.Operation.ADD_VALUE));
        attr.put(ASAttributeRegistry.MANA_STEAL, new AttributeModifier(id, 0.15, AttributeModifier.Operation.ADD_VALUE));
