...
public class EldritchWarlockArmorItem extends ImbuableDTEArmorItem {
    public EldritchWarlockArmorItem(ArmorItem.Type slot, Properties settings) {
        super(DTEArmorMaterialRegistry.ELDRITCH_WARLOCK, slot, settings, schoolAttributesWithResistance(AttributeRegistry.ELDRITCH_SPELL_POWER, AttributeRegistry.ELDRITCH_MAGIC_RESIST, 150, 0.10F, 0.05F, 0.05F));
    }
