...
import net.acetheeldritchking.discerning_the_eldritch.entity.render.armor.old.OldEldritchWarlockHelmetRenderer;
...
public class OldEldritchWarlockHelmetItem extends ImbuableOldDTEArmorItem {
    public OldEldritchWarlockHelmetItem(Type slot, Properties settings) {
    ...
    public void createRenderer(Consumer<RenderProvider> consumer) {
        consumer.accept(new RenderProvider() {
            private OldEldritchWarlockHelmetRenderer renderer;

            @Override
            public HumanoidModel<LivingEntity> getHumanoidArmorModel(LivingEntity livingEntity, ItemStack itemStack, EquipmentSlot equipmentSlot, HumanoidModel<LivingEntity> original) {
                if (renderer == null)
                {
                    renderer = new OldEldritchWarlockHelmetRenderer();
                }
